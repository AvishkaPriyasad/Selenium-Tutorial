...
public class TextBoxExample {
    ...
    public void textBoxTest(){
        ...
        name.sendKeys("Avishka Priyasad");
        ...
        driver.findElement(By.id("j_idt88:j_idt99")).sendKeys("avishkapriyasad@gmail.com" + Keys.TAB + "Confirmed control moved to next element");
